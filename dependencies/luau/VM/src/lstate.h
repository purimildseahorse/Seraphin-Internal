...
typedef struct global_State
{
    ...
    g_ttname_enc<TString*> ttname[LUA_T_COUNT],       // names for basic types
    g_tmname_enc<TString*> tmname[TM_N]);             // array with tag-method names
...
struct lua_State
{
    ...
    l_global_enc<global_State*> global,
